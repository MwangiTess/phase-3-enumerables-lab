...
def print_spicy_foods(spicy_foods)
  spicy_food_strings = spicy_foods.map do |food|
    heat_level = '🌶' * food[:heat_level]
     "#{food[:name]} (#{food[:cuisine]}) | Heat Level: #{heat_level}"
  end
  puts spicy_food_strings.join("\n")
end
...
def get_spicy_food_by_cuisine(spicy_foods, cuisine = nil)
